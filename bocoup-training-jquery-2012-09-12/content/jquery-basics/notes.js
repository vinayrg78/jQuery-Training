...
// What's the easiest way to reset all inline styles?
$("p").removeAttr("style");
...
$("p").wrapAll('<div class="highlight"/>');

// Wrap the content inside each selected element with some HTML.
$("h1").wrapInner('<span class="highlight"/>');
...
// And then programatically update that variable...
allDivsInTheDocument = allDivsInTheDocument.eq(0);

// It doesn't actually change the document.
$("div").length // 10

// It just changes the object stored in the variable.
allDivsInTheDocument.length // 1
